...
/*:
 ...
 The publisher we currently use publishes a certain amount of values and immediatly after a completion. Next we will learn about `Subjects` another concept from **Combine** that enables us to publish in an imperative fashion.
 */
